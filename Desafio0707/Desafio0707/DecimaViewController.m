...
#import "DecimaViewController.h"

@interface DecimaViewController ()

@end

@implementation DecimaViewController
...
- (void)viewDidLoad
{
    ...
    titulo.text = @"Decima View";
    
    UIImage *imagem = [UIImage imageNamed:@"5.png"];
