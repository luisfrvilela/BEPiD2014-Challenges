...
#import "NonaViewController.h"

@interface NonaViewController ()

@end

@implementation NonaViewController
...
- (void)viewDidLoad
{
    ...
    titulo.text = @"Nona View";
    
    UIImage *imagem = [UIImage imageNamed:@"4.png"];
