...
#import "SextaViewController.h"

@interface SextaViewController ()

@end

@implementation SextaViewController
...
- (void)viewDidLoad
{
    ...
    titulo.text = @"Sexta View";
    
    UIImage *imagem = [UIImage imageNamed:@"1.png"];
