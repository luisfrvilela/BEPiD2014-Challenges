...
#import "SetimaViewController.h"

@interface SetimaViewController ()

@end

@implementation SetimaViewController
...
- (void)viewDidLoad
{
    ...
    titulo.text = @"Setima View";
    
    UIImage *imagem = [UIImage imageNamed:@"2.png"];
