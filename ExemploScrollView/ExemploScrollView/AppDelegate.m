...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //Chamando a classe principal e adicionando a variavel de scrool viem no frame
    ...
    UILabel *nome = [[UILabel alloc]initWithFrame:CGRectMake(50, 150, 100, 100)];
    
    nome.text = @"Nome: Luis Filipe";
    
    [scroolView addSubview:nome];
    
    _principal = [[PrincipalViewController alloc]init];
    [_principal.view addSubview:scroolView];
    
    self.window.rootViewController = _principal;
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ExemploScrollView" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ExemploScrollView.sqlite"];
