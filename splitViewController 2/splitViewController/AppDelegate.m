...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
 ...
 //   self.window.rootViewController = masterNav;
    ...
    if([UIDevice currentDevice].userInterfaceIdiom == UIUserInterfaceIdiomPad){
        PAADetailViewController*dvc = [[PAADetailViewController alloc]initWithNibName:@"PAADetailViewController" bundle:nil];
        
        PAATableViewController *tvc = [[PAATableViewController alloc]init];
        ...
        PAADetailViewController*dvc = [[PAADetailViewController alloc]initWithNibName:@"PAADetailViewContollerIphone" bundle:nil];
